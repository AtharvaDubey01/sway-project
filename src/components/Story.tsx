...
const Story = () => {
  return (
    <section id="story" className="section bg-navy text-white">
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-lg mb-6 text-white/80">
              After countless late nights and recipe experiments, Refresh was born - 
              a delicious, healthy alternative that doesn't compromise on taste.
            </p>
            <p className="text-lg mb-6 text-white/80">
          ...
          <div className="relative">
            ...
            <img 
              src="https://images.unsplash.com/photo-1600880292203-757bb62b4baf?q=80&w=1370&auto=format&fit=crop" 
              alt="Our story" 
