        ...
        <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="text-center">
            ...
            <div className="flex justify-center gap-4 mt-2">
              <a href="https://instagram.com/refreshdrinks" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center hover:bg-coral hover:text-white transition-colors">
                <Instagram size={24} />
              </a>
              <a href="https://twitter.com/refreshdrinks" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center hover:bg-navy hover:text-white transition-colors">
                <Twitter size={24} />
              </a>
              <a href="https://facebook.com/refreshdrinks" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center hover:bg-blue-600 hover:text-white transition-colors">
                <Facebook size={24} />
              </a>
            </div>
          </div>
